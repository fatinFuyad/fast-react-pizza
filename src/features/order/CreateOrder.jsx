...
function CreateOrder() {
  ...
  const cart = useSelector(getCart); // selector expects a function expression
  ...
  return (
    <div className="m-auto max-w-screen-md px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            />
            {formErrors?.phone && (
              <p className="mt-2 rounded-full bg-red-100 px-5 py-2 text-xs text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <div className="absolute right-0 top-8 h-10 sm:top-0">
              <Button
                disabled={isLoadingAddress}
                type="small"
                style="h-full"
